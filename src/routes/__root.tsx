...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Hirely.ai" },
      { name: "theme-color", content: "#0b0b0b" },
      { property: "og:site_name", content: "Hirely.ai" },
      { property: "og:title", content: "Hirely.ai — AI Hiring OS" },
      { property: "og:description", content: "Adaptive AI interviews for candidates. Instant ranking and reasoning for recruiters." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Hirely.ai — AI Hiring OS" },
